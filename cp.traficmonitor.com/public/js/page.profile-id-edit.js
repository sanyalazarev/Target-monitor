...
$('.nav-tabs a[role=tab]').click(function (e) {
	...
	if($(this).attr("href") == "#group3" && $(this).data("choseninit") == 0) {
		$(this).data("choseninit", 1);
...
function initAutocomplete() {
	...
	autocomplete.addListener('place_changed', function () {
		...
		$('#i-live-in').val(userCity + ', ' + countryName);
...
$(".save-profile").click(function(){
	...
	dataSocket.emit('updateUserEditInfo', JSON.stringify(data));
});

dataSocket.on('updateUserEditInfo', function (data) {
